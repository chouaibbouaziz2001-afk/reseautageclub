/*
  # Fix mention regex to support numbers and underscores
  
  1. Changes
    - Update backfill_comment_mentions() function to handle usernames with numbers
    - Change regex from '@([a-zA-Z]+' to '@([a-zA-Z0-9_]+' to include digits and underscores
  
  2. Purpose
    - Support usernames like "wadieaymen0", "user123", "test_user"
    - Match real-world username patterns
*/

-- Update the function to handle numbers and underscores in mentions
