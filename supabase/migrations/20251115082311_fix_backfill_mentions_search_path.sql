/*
  # Fix search_path for backfill_comment_mentions function
  ...
  2. Security
    - Immutable search_path prevents malicious schema injection
    - All table references now explicitly use public schema
*/
